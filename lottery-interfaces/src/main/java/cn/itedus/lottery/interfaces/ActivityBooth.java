...
public class ActivityBooth implements IActivityBooth {
    ...
    public ActivityRes queryActivityById(ActivityReq req) {
        ...
        return new ActivityRes((javax.xml.transform.Result) new Result(Constants.ResponseCode.SUCCESS.getCode(), Constants.ResponseCode.SUCCESS.getInfo()), activityDto);
    }
